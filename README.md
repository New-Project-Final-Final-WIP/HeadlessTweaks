...
### Disabling the interactive command prompt
If you run your server truly headless as a daemon, this can be useful to prevent some console spam generated by the interactive command system.
```json
